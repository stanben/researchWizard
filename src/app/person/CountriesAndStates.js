...
var findCountry = function (name) {
    int loc = country_arr.binaryIndexOf(name);
    return loc;      // Country not found
}

var searchForProvince = function(list,name) {
    return list.indexOf(name);
}

var findProvince = function (name,countryID) {
    if (countryId >= 0) {
        var loc = searchForProvince(province_arr[countryId],name);
        return loc;
    }
